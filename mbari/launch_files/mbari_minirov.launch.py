...
def generate_launch_description():
    ...
    left_calib_path = os.path.join(
        get_package_share_directory('rtabmap_ros'), 'launch', 'camera_calibrations', 'MINIROV_2023_04', 'rtabmap_calib_left.yaml'
    )
    right_calib_path = os.path.join(
        get_package_share_directory('rtabmap_ros'), 'launch', 'camera_calibrations', 'MINIROV_2023_04', 'rtabmap_calib_right.yaml'
    )
